...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const airport3Input = document.getElementById('airport3');
    ...
    function fetchMetarData(airportCode, columnNumber) {
    ...
    function updateDisplay(data, columnNumber) {
        const column = document.querySelector(`.column${columnNumber}`);
        if (!column)
            return;
